...
public class Categoris_waste_model {
    ...
    public Categoris_waste_model(String typeOfCat, String quantity, String price, String location, String contactNo, String priceUnite, String uaserId, boolean sell) {
