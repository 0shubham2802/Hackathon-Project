...
public class waste_model {
    String waste_name;
    String waste_image_url;
    String Waste_price;
    String waste_Quantity = "Quantity: 30cn";
    String waste_location;
    String Contact_no = "7894561230";
    String Company_name;
    String Track_location;


    public waste_model(String waste_name, String waste_image_url, String waste_price,
    ...
    public waste_model(String waste_name, String waste_image_url, String waste_price, String waste_location) {
        this.waste_name = waste_name;
        this.waste_image_url = waste_image_url;
        Waste_price = waste_price;
        this.waste_location = waste_location;
